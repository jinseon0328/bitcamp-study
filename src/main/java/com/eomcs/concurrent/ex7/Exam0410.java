...
public class Exam0410 {
  ...
  public static void main(String[] args) {
    ...
    executorService.execute(new MyRunnable(2000)); // 2번
    executorService.execute(new MyRunnable(4000)); // 3번
    executorService.execute(new MyRunnable(4000)); // 4번
    executorService.execute(new MyRunnable(4000)); // 5번
    executorService.execute(new MyRunnable(4000)); // 6번
