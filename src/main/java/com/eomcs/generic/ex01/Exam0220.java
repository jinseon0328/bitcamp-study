...
public class Exam0220 {
  ...
  public static void main(String[] args) {
    ...
    b2.set("Hello"); // 스트링 상수풀에 스트링 변수를 만든다
    b3.set(new Date()); // auto-boxing ==> box3.set(Integer.valueOf(100)) 문장으로 변경된다.
    b4.set(100);
    ...
    // => 값을 꺼낼 때마다 형변환 해야 한다.
    //
    Member v1 = (Member) b1.get(); // auto-unboxing ==> ((Integer) b1.get())intValue) 문장으로 변경된다.
    // <= 리턴값.intValue()
