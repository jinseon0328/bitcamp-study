...
public class Exam0211 {
  public static void main(String[] args) {
    ...
    ArrayList/*<타입명> 레퍼런스에 제한된 제너릭이 없는 것*/ list1; 
    list1 = new ArrayList();
    list1 = new ArrayList<>();
    ...
    ArrayList<?> list2;  // ArrayList에 뭘 담을지 모르겠지만 어떤 거든 가리킬게
    ...
    //    list2.add(new String()); // 컴파일 오류! 레퍼런스에 가보니까 String을 담을 수 있는지 없는지 모르겠어 컴파일 안해!
