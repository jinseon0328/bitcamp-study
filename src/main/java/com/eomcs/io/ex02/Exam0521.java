...
public class Exam0521 {
  ...
  public static void main(String[] args) throws Exception {
    ...
    // - 바이트 배열에 저장된 문자 코드를 JVM이 사용하는 문자 집합(UCS2=UTF16BE)의 코드 값으로 변환한다.
    // - 바이트 배열에 들어 있는 코드 값이 어떤 문자 집합의 값인지
    //   알려주지 않는다면?
    //   JVM 환경 변수 file.encoding에 설정된 문자 집합으로 가정하고 변환을 수행한다.
    String str = new String(buf, 0, count); 
    //---utf-16으로 넣는다  ---바이트 배열을 받아서 바꾸는 생성자
    // 주고 받을 때는 UTF-8로 주고 받고 가끔은 UCS-2를 쓰기도 한다
