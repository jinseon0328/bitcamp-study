...
public class Exam0525 {
  ...
  public static void main(String[] args) throws Exception {
    ...
    FileInputStream in = new FileInputStream("sample/utf16le.txt"); // 0041 0042 ac00 ac01
    ...
    String str = new String(buf, 0, count, "UTF-16LE"); // UTF-16BE 라고 생각하므로 정확하게 LE라고 알려줘야한다
