...
public class RequestProcessor extends Thread {
  ...
  public RequestProcessor(Socket accept) {
    this.socket = socket;
  }
  ...
  /*
   * private void sendIntroMessage(PrintStream out) throws Exception { out.println("계산기 서버입니다");
   * out.println("계산식을 입력하세요"); out.println("예) 23 + 7"); out.println(); // 응답의 끝을 표시하는 빈 줄을 보낸다
   * out.flush(); }
   */
