...
public class Exam0120 {
  ...
  public static void main(String[] args) {
    ...
    //  => proxy 레퍼런스가 가리키는 객체가 Calculator, Calculatror2, Calculator3 인터페이스를
    // 구현한 클래스일지라도 일단 proxy 레퍼런스의 타입이 Object 이기 때문에
    // 바로 인터페이스의 메서드를 호출 할 수 없다.
    // 해결책?
    //  레퍼런스를 바로 사용하지 말고 해당 인터페이스로 형변환한 다음에 사용하라.
    //    int result = 0;
    //    result = proxy.plus(10, 20); // 컴파일 오류! 프록시 객체가 Object type이므로
