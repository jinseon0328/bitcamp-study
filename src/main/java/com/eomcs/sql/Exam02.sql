...
```
- null인 컬럼을 전체 다 바꿀 때 
update test1 set fax='111' pstno='100' where fax=null /*오류*/
update test1 set fax='111' pstno='100' where fax is null;
update test1 set fax='xxx' where addr is not null;

-null을 필수로 바꾼다
modify column fax varchar(20) not null; /*오류*/
update test1 set fax='' where is null;
alter table test1
modify column fax varcha(20) not null;

alter table test1
modify column pstno varchar(20) not null default '111'; /*오류*/
